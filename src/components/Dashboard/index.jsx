...
const Dashboard = () => {
  ...
  const reportTypes = [
    { id: 'portfolio-summary', name: 'Portfolio Summary', icon: BarChart3 },
    { id: 'member-analysis', name: 'Member Analysis', icon: Users },
    { id: 'financial-performance', name: 'Financial Performance', icon: DollarSign },
    { id: 'compliance-report', name: 'Compliance Report', icon: Shield },
